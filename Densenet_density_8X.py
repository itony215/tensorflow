...
train_data='CBIS-DDSM/cut_1000_3000_X2_train/'
test_data='CBIS-DDSM/cut_1000_3000_X2_test/'
train_dir = 'traindata/'
# Hyperparameter
growth_k = 12
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter('./logs_cut_X2', sess.graph)
    train_image=[]
    train_label=[]
    test_image = []
    test_label = []
    ...
    saver.save(sess=sess, save_path='./model/dense_cut_X2.ckpt')
